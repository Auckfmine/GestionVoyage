 ...
 */
final class Version20211119005207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE voyage (id INT AUTO_INCREMENT NOT NULL, station_depart_id INT NOT NULL, station_arrive_id INT NOT NULL, moyen_de_transport_id INT NOT NULL, ref_voyage VARCHAR(128) NOT NULL, ligne LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', date_depart DATETIME NOT NULL, date_arrive DATETIME NOT NULL, UNIQUE INDEX UNIQ_3F9D89554A84E1AC (ref_voyage), UNIQUE INDEX UNIQ_3F9D89552C869050 (station_depart_id), UNIQUE INDEX UNIQ_3F9D89557686E853 (station_arrive_id), INDEX IDX_3F9D89554B31287 (moyen_de_transport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
